...
class PlaceholderInputWidget extends StatefulWidget {
  final String label;
  ...
  @override
  _PlaceholderInputWidgetState createState() => _PlaceholderInputWidgetState();
}

class _PlaceholderInputWidgetState extends State<PlaceholderInputWidget> {
