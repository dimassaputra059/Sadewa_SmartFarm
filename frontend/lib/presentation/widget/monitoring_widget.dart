...
import '../pages/pengaturan_sensor.dart';
import 'grafik_widget.dart'; // Pastikan SensorChart diimpor dengan benar

class MonitoringWidget extends StatefulWidget {
  final String sensorName;
  final String sensorValue;
  final List<Map<String, dynamic>> sensorData; // Data untuk grafik
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: SensorChart(sensorData: widget.sensorData),
          ),
        ],
      ),
    );
